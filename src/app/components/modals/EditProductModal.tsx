...
export function EditProductModal({ isOpen, onClose, product, onUpdate }: EditProductModalProps) {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      prix: product.prix !== undefined ? String(product.prix) : '',
      quantiteStock: product.quantiteStock !== undefined ? String(product.quantiteStock) : '',
      imageUrl: product.imageUrl || '',
      statut: product.statut || 'disponible',
      marque: product.marque || '',
      estBestseller: Boolean(product.estBestseller),
      note: product.note !== undefined ? String(product.note) : '',
      capteurs: product.specifications?.capteurs?.join(', ') || '',
      connectivite: product.specifications?.connectivite || '',
    });
  }, [product]);
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Modifier le produit - ${product.nom}`} maxWidth="xl">
