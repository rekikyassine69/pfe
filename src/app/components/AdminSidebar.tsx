...
export function AdminSidebar({ currentPage, onNavigate, onLogout }: AdminSidebarProps) {
  ...
  const menuItems = [
    ...
    { id: 'admin-pots', label: 'Gestion Pots', icon: Flower2 },
    { id: 'admin-shop', label: 'Gestion Boutique', icon: Store },
    { id: 'admin-orders', label: 'Gestion Commandes', icon: ShoppingCart },
    { id: 'admin-courses', label: 'Gestion Cours', icon: BookOpen },
    { id: 'admin-games', label: 'Gestion Jeux', icon: Gamepad2 },
